    ...
    if (bookings.length === 0) {
        ...
        for (let i = 0; i < sortedBookings.length; i++) {
            ...
            content += `
                <li class="day-overview-booking">
                    <div>
                        ...
                        <div class="booking-customer-name">${booking.customer}</div>
                        <div class="booking-services-list">${booking.services.join(', ')}</div>
                    </div>
            ...
            if (i < sortedBookings.length - 1) {
                ...
                const gapMinutes = timeToMinutes(nextBooking.time) - timeToMinutes(endTime);
                if (gapMinutes > 0) {
                    content += `
                        <li class="day-overview-booking">
